...
This should output some crazy string. This isn't the friendliest way to send data, so lets do something about that. The easiest thing to do is Base 64 encode the data, and maybe <a href="http://snippets.dzone.com/posts/show/1260">URI escape</a> it for good measure.
